...
export function UserSignupPage({ onSignupSuccess }: UserSignupPageProps) {
    ...
    return (
        <div className="animated-login-wrapper">
            ...
            <div className="box">
                {/* Back Button */}
                <button onClick={() => navigate('/user-login')} className="absolute-back-btn">
                ...
                <div className="form">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="footer-links">
                            ...
                            <a href="#" onClick={(e) => { e.preventDefault(); navigate('/user-login', { replace: true }); }}>Login</a>
                        </div>
                    </form>
                </div>
            </div>
