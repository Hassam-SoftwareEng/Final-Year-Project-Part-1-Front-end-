...
const HomePage: React.FC<HomePageProps> = ({
    ...
    onNavigateToNewMatches = () => console.log('Navigate to New Matches'),
    ...
    onNavigateToCreateProfile = () => console.log('Navigate to Create Profile'),
    onNavigateToSetting = () => console.log('Navigate to Setting'),
    onNavigateToRedFlagAlert = () => console.log('Navigate to Red Flag Alert'),
    ...
    const handleSettings = onNavigateToSetting || onNavigateToSettings;
    const handleNotification = onNavigateToNotification || onNavigateToNotifications;
                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="dashboardNavbar">
                        ...
                        <div className="d-flex align-items-center gap-3">
                            {handleSettings && (
                                <a className="nav-link text-secondary fw-medium" href="#" onClick={(e) => { e.preventDefault(); handleSettings(); }}>Setting</a>
                            )}
                            {handleNotification && (
                                <button
                                    className="btn btn-link text-secondary p-0 border-0"
                                    onClick={(e) => { e.preventDefault(); handleNotification(); }}
                                >
                                    <Bell size={20} />
                                </button>
                            )}
