...
import '../../styles/Property Owner(User)/ListingPage.css';
...
export const ListingPage: React.FC<ListingPageProps> = ({
    ...
    // Use onNavigateToHome or fall back to dashboard
        ...
        <div className="listing-page-container">
            ...
            <main className="listing-content">
                ...
                <div className="listing-header" style={{ padding: '0 32px', marginBottom: '20px' }}>
                    <h1 className="listing-title">Your Listing (Property Owner)</h1>
