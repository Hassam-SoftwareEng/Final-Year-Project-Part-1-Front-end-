...
import '../../styles/Property Owner/ForRent.css';
...
export const ForRent: React.FC<ForRentProps> = ({
    onLogout,
        ...
        <div className="dashboard-container">
            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-white border-bottom shadow-sm sticky-top px-3">
                <div className="container-fluid">
                    ...
                    <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#rentNavbar">
                        <span className="navbar-toggler-icon"></span>
                    </button>

                    <div className="collapse navbar-collapse" id="rentNavbar">
            ...
            <div className="main-content">
                <header className="dashboard-header">
                    <div className="header-title-group">
                        ...
                        <p className="header-subtitle">View and manage properties currently for rent.</p>
                    </div>
                </header>
                ...
                <div className="saved-listings-container">
                    ...
                    <div className="listing-card-modern hover-scale">
                        ...
                        <div className="listing-details">
                            ...
                            <button className="btn-standard w-100 mt-2" onClick={() => navigate('/property-owner-view-rent-listing?id=rent-1')}>View</button>
                        </div>
                    </div>
                    <div className="listing-card-modern hover-scale">
                        ...
                        <div className="listing-details">
                            ...
                            <button className="btn-standard w-100 mt-2" onClick={() => navigate('/property-owner-view-rent-listing?id=rent-2')}>View</button>
                        </div>
                    </div>
                </div>
            </div>
